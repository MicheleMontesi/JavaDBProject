...
\begin{tabularx}{\textwidth}{cXl}
        ...
        \hline
        8 & Registrare l'acquisto di farmaci & 15 al mese \\
        \hline
        9 & Visualizzare tutti i pazienti con una data terapia & 10 al giorno \\
        \hline
        10 & Registrare la stipulazione di un contratto già esistente & 10 all'anno \\
        \hline
        11 & Visualizzare tutti i dipendenti con un contratto specifico & 10 al mese\\
        \hline
        12 & Visualizzare tutti i dipendenti di turno in un giorno della settimana & 1 al giorno \\
        \hline
        13 & Registrare un nuovo turno & 1 al mese \\
        \hline
        14 & Aggiornare un turno già esistente & 10 al mese \\
        \hline
\end{tabularx}
...
\subsubsection*{OP 6 - Registrare l'acquisto di beni strumentali}
