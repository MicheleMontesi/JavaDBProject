...
\begin{changemargin}{0.5cm}{0.5cm}
        ...
        sanitarie psichiatriche}) adibite all' \textbf{ospitazione} di piú pazienti (la quale dovrà essere registrata
        con data d'inizio e opzionalmente con una data di fine).
        Queste sono caratterizzate dalla loro ubicazione, i posti letto e il numero dei pazienti.
        Per poter essere operative devono ricevere un'\texttt{autorizzazione al funzionamento} e l'\texttt{accreditamento}.
\end{changemargin}
